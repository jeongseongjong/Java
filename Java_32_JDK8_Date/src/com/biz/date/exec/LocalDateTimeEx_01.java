...
public class LocalDateTimeEx_01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(local.with(TemporalAdjusters.firstDayOfYear())); // 올해 첫 날
		System.out.println(local.with(TemporalAdjusters.firstDayOfNextYear())); // 내년 첫 날
		System.out.println(local.with(TemporalAdjusters.lastDayOfYear()));// 올해 마지막 날
		System.out.println(local.with(TemporalAdjusters.lastDayOfMonth()));// 이달의 마지막 날
		System.out.println(local.with(TemporalAdjusters.firstInMonth(DayOfWeek.MONDAY))); // 요번주 첫번째 월요일 날짜
		System.out.println(local.with(TemporalAdjusters.firstInMonth(DayOfWeek.SUNDAY))); // 이달의 첫번째 일요일 날짜
		System.out.println(local.with(TemporalAdjusters.lastInMonth(DayOfWeek.SUNDAY))); // 이번달의 마지막 일요일 날짜
		...
		System.out.println(local.with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))); // 오늘 포함해서 지난주 일요일 
